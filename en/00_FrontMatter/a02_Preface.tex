...
% The footnotes in this section will be "numbered" with symbols, not numbers:
\setupnotation
  [footnote]
...
{\it A not so short introduction to \ConTeXt\ Mark~IV} (sometimes referred
to as ANSS, at least among English-speaking \ConTeXt\ users) by Joaquín
Ataz-López is a highly regarded reference document for \ConTeXt\ users, and
is of particular value to new \ConTeXt\ users, regardless of whether they
had previous experience with plain \TeX, \LaTeX, or no experience with
the \TeX\ family at all.  The fact that it has been translated from
its original Spanish into five other languages is evidence of its wide appeal.

Time moves on, and so does \ConTeXt.  I will go out on a limb and
conjecture that in 2026 most \ConTeXt\ users are now
using \ConTeXt~LMTX\null.  Although the Mark~IV and LMTX versions
of \ConTeXt\ are quite similar, some of the information in ANSS does not
reflect the current behaviour of \ConTeXt\ LMTX\null.  Further, there are
new features in LMTX which are worthy of mention.

Joaquín has graciously offered his support to the idea of creating a
new \quotation{community edition} of his book.  At the same time, a (minor)
change in title and attribution is appropriate to reflect both the target
version of \ConTeXt\ as well as the wider authorship (although Joaquín's
efforts will always be the fundamental basis of this new book).

The \ConTeXt\ source for {\bf this} book is currently found at
\from[SourceCode].  Contributions by all \ConTeXt\ users are welcome.  For
those familiar with {\tt git\/}, pull requests are welcome.  Opening
an \quotation{issue} at the Codeberg site is another way to make a
contribution.  A third choice is to email patches to one of the
maintainers.  Finally, significant changes to the book (such as ideas for a
minor or major restructuring) might be best handled via the \ConTeXt\
mailing list.

An adaptation of an existing book deserves a new preface.  I decided to do
that, in order to get the project moving forward.  However, I must
unambiguously and clearly emphasize that I have no special status among the
contributors; I am not a \ConTeXt\ expert, nor have I experience writing
technical documents of this magnitude.  My hope is that many members of
the \ConTeXt\ community will contribute according to their skills and
available time, in order to provide a useful and up to date document for
all \ConTeXt\ users.

The preface to ANSS is included in this book for a number of reasons, only
four of which I mention here.
First, it explains the rationale behind the development of ANSS;
\Conjecture\ these reasons live on, and partially explain why
this \quotation{ANSS-CE} book is considered to be worthwhile.  Second, it
explains what the two images seen here in the left margin mean, which is
information the reader will surely want.  Third, that preface includes a
bit of historical background \Doubt to \TeX\ and \ConTeXt\ that I believe
is well worth the few minutes it will take to read.  Fourth, the overall
structure of ANSS (and thus ANSS-CE unless major changes are made some
time in the future) is explained, which should help the reader better
understand what the book attempts to do, and how it attempts to do that.

Finally, except for this preface, all uses of the word “I” refer to Joaquín
Ataz-López.  Although the number of “I”s may go down as this book evolves,
the origins of this book will always remain with ANSS\null.

\blank

\rightaligned{Jim Diamond}\\
\rightaligned{March 2026}
...
\writetolist[chapter]{}{List of Contributors}

This section lists the people known to have contributed to this book (in
small ways or big ways); it is undoubtedly missing many people.  If your
name belongs here, please report the omission as described in the preface.
(If your name is here and you would modestly like it changed to 
\quotation{Anonymous \#<n>}, let a maintainer know.)

\startlines
{\bf Joaquín Ataz-López} (author of ANSS)
{\bf Anonymous \#1} (translator of the Spanish book into English)
...
\starttitle
  [title=Preface to \quotation{A not so short introduction to \ConTeXt\
      Mark~IV}\footnote{This preface began with the intention of being
...
\writetolist[chapter]{}{Preface to \quotation{A not so short introduction to \ConTeXt\ Mark~IV}}
...
has become LMTX\null. However, for those coming to the world of ConTeXt for
...
% Without a \page here, the last page of this preface gets the headertexts
